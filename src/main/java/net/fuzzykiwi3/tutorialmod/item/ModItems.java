package net.fuzzykiwi3.tutorialmod.item;
...
public class ModItems {
    ...
    public static final Item LIGHTNING_HAMMER = registerItem("lightning_hammer", new LightningHammerItem(new Item.Settings().maxDamage(64)
